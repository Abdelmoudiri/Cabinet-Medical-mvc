...
<body>
    <!-- HEADER SECTION -->
    <header class="bg-gary">
        <!-- BARRE DE NAVIGATION -->
        <nav class="py-5 px-5 md:px-10 bg-zinc-600 shadow md:flex md-items-center md:justify-between">
            ...
            <ul id="links" class="md:flex md:items-center z-[1] md:z-auto md:static absolute  w-full top-[80px] md:w-auto md:py-0 pb-4 md:pl-0 pl-7 md:opacity-100 opacity-0 left-[-400px] transition-all ease-in duration-500 md:h-auto h-screen">
                ...
                <li class="mx-4 my-6 md:my-0 md:text-lg hover:text-[#01FF70] duration-500 font-medium">
                    <a href="./doctors.php">Nos Médecins</a>
                </li>
